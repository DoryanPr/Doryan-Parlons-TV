    ...
    return (
        ...
        <StyledMessageBoxItem>
            <div className="chat__messages-box-item">
                <Row>
                    <Col xs={2}>
                        <Avatar avatar_url={sender && sender.profile ? sender.profile.picture : ''} />
                    </Col>
                    <Col>
                        <div className="chat__messages-box-item-message">
                            <div className="chat__messages-box-item-message-header">
                                <a
                                    href={ sender ? '/profile/' + sender._id : '' }
                                    className="chat__messages-box-item-message-header-name">
                                    {sender && sender.profile ? sender.profile.name : ''}</a>
