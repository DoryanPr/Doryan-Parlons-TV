    ...
    return (
        <StyledProfile>
            ...
            <div className="profile--desc">
                <span>Ce n'est pas votre nom de connexion ou code pin. Ce nom sera visible aupres de vos contacts </span>
            </div>
            <ProfileForm
                type="actu"
            ...
            {!isMe && !isInFriendList() ? (
                <button className="profile-add-friend" onClick={props.onAddFriend}>
