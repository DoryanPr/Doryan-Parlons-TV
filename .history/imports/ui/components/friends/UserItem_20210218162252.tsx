        ...
        <StyledUserItem>
            ...
            { isInFriendList() ? (
                <Col>
                    ...
                    <Col>
                        <input className="chat--content-add-friend" onClick={onAddFriend}>
                            <i className="fas fa-user-plus"></i>
                        </input>
                        <input className="chat--content-send-message" onClick={onMessage}>
                            <i className="far fa-comments"></i>
                        </input>
                    </Col>
                )
...
export default withTracker(({ id }) => {
    ...
    /*
        const myFriends = Meteor.users.find({
            _id: {
