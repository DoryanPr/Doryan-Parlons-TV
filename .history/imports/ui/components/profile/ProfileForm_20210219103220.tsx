...
const profile_form = (props: any): JSX.Element => {
    ...
    const updateUsername = (_id: string): void => {
        console.log(_id, "id update username");
        Meteor.call('user.name', { _id: _id }, (err, id) => {
            if (err) {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>, name: string, actu: string): void => {
