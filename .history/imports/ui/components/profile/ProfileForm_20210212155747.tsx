        ...
        <StyledProfileForm>
            ...
            {!editable ? (
                <div className="profile_form--container">
                    <input
                        readOnly={true}
                        className="profile_form--container--input__border"
                        value={state}
                    />
                    <FontAwesome
                        className="profile_form--icon"
                        name="pen"
                        onClick={toggleEditable}
                    />
                </div>
            ) : (
                    <div className="profile_form--container--container">
                        <input
                            readOnly={false}
                            className="profile_form--input __border"
                            value={state}
