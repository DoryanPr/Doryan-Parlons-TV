...
export default withTracker(({ match }) => {
    ...
    let channel = match.params.channel ? ChannelsCollection.findOne({ link: match.params.channel 
    }) : ChatsCollection.findOne({ _id: match.params.chat });

    let otherChannels = match.params.channel ? ChannelsCollection.find({ link: { $ne: match.params.channel }
