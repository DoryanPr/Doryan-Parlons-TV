                    ...
                    <Col>
                        <div className="chat__messages-box-item-message">
                            <div className="chat__messages-box-item-message-header">
                                <p className="chat__messages-box-item-message-header-name">{sender && sender.profile ? sender.profile.name : ''}</p>
                            ...
                            <div className="chat__messages-box-item-message-content">{
                                ...
                                type === MessageType.TEXT ? (
                                    ...
                                    <p> {content? (String.fromCodePoint(parseInt(content, 16)) : else (null))} </p>
                                ) : (
                                            <img
                                                src={content}
