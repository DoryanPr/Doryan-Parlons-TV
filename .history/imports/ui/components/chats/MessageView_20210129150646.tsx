...
import { findChannels, findChat, findOneById, findTwentyLastMessage } from '../../../api/helpers';
...
export default withTracker(({ match }) => {
    ...
    const message = MessagesCollection({ sender: match.params.username });
