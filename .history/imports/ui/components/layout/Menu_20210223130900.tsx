...
const Menu = () => {
    ...
    return (
        <StyledMenu >
            ...
            {Meteor.user() ?
                (<StyledAvatar>
                    <a href={"/profile/" + Meteor.userId()} className="profile-link" >
            ...
            {userId ? (
                <a href="#" onClick={logout} className="menu-connection">Se déconnecter</a>
            ) : (
                    <a href="/sign-in" className="menu-connection">Se connecter</a>
                )}
        </StyledMenu>
    )
}
